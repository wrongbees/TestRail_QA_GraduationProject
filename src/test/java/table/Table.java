...
public class Table {
    ...
    public UIElement getDeleteCell(String projectName) {
        return getRowByText(projectName).getCellByIndex(3);
    }

    public UIElement getEditCell(String projectName) {
        return getRowByText(projectName).getCellByIndex(2);
    }
